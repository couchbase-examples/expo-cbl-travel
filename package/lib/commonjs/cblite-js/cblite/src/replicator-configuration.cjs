...
var _collectionConfig = require("./collection-config.cjs");
...
class ReplicatorConfiguration {
  ...
  addCollection(collection, config) {
    ...
    if (config === undefined || config === null) {
      config = new _collectionConfig.CollectionConfig(undefined, undefined);
    }
  ...
  checkCollectionsScopeAndDatabase() {
...
//# sourceMappingURL=replicator-configuration.cjs.map