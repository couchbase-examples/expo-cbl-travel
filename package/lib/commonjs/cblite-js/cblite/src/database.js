...
Object.defineProperty(exports, "LogDomain", {
  enumerable: true,
  get: function () {
    return _logSinksEnums.LogDomain;
  }
});
Object.defineProperty(exports, "LogLevel", {
  enumerable: true,
  get: function () {
    return _logSinksEnums.LogLevel;
  }
});
exports.MaintenanceType = void 0;
var _document = require("./document.js");
var _databaseLogging = require("./database-logging.js");
...
var _logSinksEnums = require("./log-sinks-enums.js");
...
class Database {
  ...
  async getDocument(id) {
    ...
    if (docJson && docJson._id) {
      ...
      return Promise.resolve(new _document.Document(retId, sequence, revisionID, collection, data));
    } else {
