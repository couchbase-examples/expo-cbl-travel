...
import { FullTextIndexItem, IndexBuilder, MutableDocument, Parameters } from "../../cblite/index.mjs";
...
export class QueryTests extends TestCase {
  ...
  async testJoinWithCollections() {
    try {
      ...
      //add documents
      await flowersCol.save(new MutableDocument('c1', null, {
        name: 'rose',
        cid: 1
      }));
      ...
      await colorsCol.save(new MutableDocument('c1', null, {
        color: 'red',
        cid: 1
      }));
      await colorsCol.save(new MutableDocument('c2', null, {
        color: 'blue',
        cid: 2
      }));
      await colorsCol.save(new MutableDocument('c3', null, {
        color: 'white',
        cid: 3
      }));
  ...
  async testSelectAllResultKey() {
    try {
      ...
      await this.defaultCollection.save(new MutableDocument('c1', null, {
        name: 'rose',
        cid: 1
      }));
...
//# sourceMappingURL=query-test.mjs.map