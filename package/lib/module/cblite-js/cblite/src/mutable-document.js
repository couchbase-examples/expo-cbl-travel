...
export class MutableDocument extends Document {
  ...
  constructor(id = null, sequenceNoOrData = null, revisionIDOrData = null, data = {}, collection = null) {
    if (arguments.length === 0) {
      ...
      super(id, sequenceNoOrData, null, null, revisionIDOrData || {});
    } else {
      // Full constructor
      super(id, sequenceNoOrData, revisionIDOrData, collection, data);
    }
    this._blobs = {};
  }
  ...
  */
  static fromDocument(document) {
    return new MutableDocument(document.getId(), document.getSequence(), document.getRevisionID(), document.getData(), document.getCollection());
  }
  static fromJSON(documentId, jsonString) {
    try {
...
//# sourceMappingURL=mutable-document.js.map