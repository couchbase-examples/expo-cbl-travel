...
export declare class Database {
    ...
    private _databaseUniqueName;
    private _isClosed;
    private _engine;
    log: DatabaseLogging;
    constructor(_databaseName: string, _databaseConfig?: DatabaseConfiguration, _databaseUniqueName?: string);
     ...
     * @function
     */
    scope(scopeName: string): Promise<Scope | undefined>;
    /**
