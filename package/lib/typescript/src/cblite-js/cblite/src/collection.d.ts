...
export declare class Collection {
     ...
     * }
     */
    private _docListenerTokens;
    private _cblListenerTokensByUuid;
    private _cblDocumentListenerTokensByUuid;
    /**
     * CONSTRUCTOR
     * ===========
     ...
     * @function
     */
    addChangeListener(listener: CollectionChangeListener): Promise<ListenerToken>;
    /**
     ...
     * @function
     */
    addDocumentChangeListener(documentId: string, listener: DocumentChangeListener): Promise<ListenerToken>;
    /**
     * ==================
     * DOCUMENT OPERATIONS
     * ==================
     ...
     * @function
     */
    removeDocumentChangeListener(token: string | ListenerToken): Promise<void>;
    /**
