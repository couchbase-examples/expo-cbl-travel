 ...
 * */
export declare class CollectionTests extends TestCase {
    constructor();
    /**
    ...
    testDeletePreSaveDoc(): Promise<ITestResult>;
    testDeleteSameDocTwice(): Promise<ITestResult>;
    testDeleteNoneExistingDoc(): Promise<ITestResult>;
    testPurgePreSaveDoc(): Promise<ITestResult>;
    testPurgeDoc(): Promise<ITestResult>;
    testPurgeSameDocTwice(): Promise<ITestResult>;
    testPurgeDocumentOnADeletedDocument(): Promise<ITestResult>;
    /**
    ...
    isErrorCreatingCollection(name: string, scopeName: string): Promise<boolean>;
}
