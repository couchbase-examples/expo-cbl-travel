...
export class CblReactNativeEngine {
    ...
    CblReactNative: any;
    _eventEmitter: _reactNative.NativeEventEmitter;
    startListeningEvents: (event: any, callback: any) => _reactNative.EmitterSubscription;
...
//# sourceMappingURL=CblReactNativeEngine.d.cts.map