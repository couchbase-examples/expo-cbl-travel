...
export class Collection {
     ...
     * }
     */
    _cblListenerTokensByUuid: Map<any, any>;
    _cblDocumentListenerTokensByUuid: Map<any, any>;
    _documentChangeListener: Map<any, any>;
    _docListenerTokens: Map<any, any>;
    /**
     * PUBLIC PROPERTIES
     * =================
     */
     ...
     * @function
     */
    addChangeListener(listener: any): Promise<_listenerToken.ListenerToken>;
    _changeListener: any;
    /**
     ...
     * @function
     */
    addDocumentChangeListener(documentId: any, listener: any): Promise<_listenerToken.ListenerToken>;
    /**
     * ==================
     * DOCUMENT OPERATIONS
     * ==================
...
import _listenerToken = require("./listener-token.js");
