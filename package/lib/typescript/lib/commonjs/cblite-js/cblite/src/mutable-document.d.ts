...
export class MutableDocument extends _document.Document {
    /**
    ...
    */
    ...
    static fromJSON(documentId: any, jsonString: any): MutableDocument;
    constructor(id?: any, sequenceNoOrData?: any, revisionIDOrData?: any, data?: {}, collection?: any, ...args: any[]);
    _blobs: {};
    /**
...
import _document = require("./document.js");
