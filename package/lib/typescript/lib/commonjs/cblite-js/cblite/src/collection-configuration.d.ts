...
export class CollectionConfiguration {
     ...
     * ```
     */
    static fromCollections(collections: any): any;
    /**
     ...
     * ```
     */
    setDocumentIDs(documentIds: any): this;
    /**
...
//# sourceMappingURL=collection-configuration.d.ts.map