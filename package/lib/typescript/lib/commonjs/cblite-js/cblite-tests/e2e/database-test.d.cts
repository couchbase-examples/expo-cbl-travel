 ...
 * */
export class DatabaseTests extends _testCase.TestCase {
    /**
    ...
    testDefaultDatabaseConfiguration(): Promise<{
        testName: string;
        success: boolean;
        message: string;
        data: any;
    }>;
    testDatabaseEncryptionChangeKey(): Promise<{
        testName: string;
        success: boolean;
        message: string;
        data: any;
    }>;
    testCopyingDatabaseConfiguration(): Promise<{
        testName: string;
        success: boolean;
        message: string;
        data: any;
    }>;
    testCopyingDatabase(): Promise<{
        testName: string;
        success: boolean;
        message: string;
        data: any;
...
//# sourceMappingURL=database-test.d.cts.map