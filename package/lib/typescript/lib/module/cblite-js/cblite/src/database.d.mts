export let LogDomain: {};
export let LogLevel: {};
export let MaintenanceType: {};
/**
...
export class Database {
     ...
     * @function
     */
    scope(scopeName: any): Promise<Scope>;
    /**
     ...
     * @function
     */
    collection(collectionName: any, scopeOrName: any): Promise<Collection>;
    /**
     * Get all collections in the specified scope.
     *
     * @function
     */
    collections(scopeOrName: any): Promise<Collection[]>;
    /**
     ...
     * @function
     */
    createCollection(collectionName: any, scopeOrName: any): Promise<Collection>;
    /**
     ...
     * @function
     */
    createQuery(queryString: any): Query;
}
import { DatabaseLogging } from "./database-logging.mjs";
